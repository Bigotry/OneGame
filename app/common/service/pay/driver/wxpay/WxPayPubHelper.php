...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".$this->partnerkey;	//WxPayConf_pub::KEY;
	...
	function createXml()
	{
		try
		{
		    ...
		    $this->parameters["sign"] = $this->getSign($this->parameters);//签名
		     ...
		     //echo 'hh:'.__LINE__;vde($this->parameters);
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	...
		   	$this->returnParameters["mch_id"] = $this->partnerid;//商户号
...
// 	var 
	...
	{
		$urlObj["appid"] 			= $this->appid;	//$this->appid;
	...
	{
		$jsApiObj["appId"] = $this->appid;//$this->appid;
		$timeStamp = time();
