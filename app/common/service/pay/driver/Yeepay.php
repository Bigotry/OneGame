...
class Yeepay extends Pay implements Driver
{
    ...
    public function getDriverParam()
    {
        ...
        return ['yeepay_merid' => '易宝商户号', 'yeepay_key' => '易宝密钥',"icon" => "支付方式图标"];
    }
    ...
    public function driverInfo()
    {
        ...
        return ['driver_name' => '易宝支付', 'driver_class' => 'Yeepay', 'driver_describe' => '易宝支付', 'author' => 'Bigotry', 'version' => '1.0'];
    }
    ...
    public function getPayCode($order)
    {
        ...
        #	支付金额,必填.
        ##单位:元，精确到分.
        $data['p3_Amt']             = $order['order_money'];
        #	交易币种,固定值"CNY".
        $data['p4_Cur']             = "CNY";
        $data['p5_Pid']             = "";
        #	商户接收支付成功数据的地址,支付成功后易宝支付会向该地址发送两次成功通知.
        $data['p8_Url']             = Pay::NOTIFY_URL;
