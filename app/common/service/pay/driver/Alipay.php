...
class Alipay extends Pay implements Driver
{
    ...
    public function getDriverParam()
    {
        ...
        return ['alipay_account' => '支付宝帐户', 'alipay_partner' => '合作身份者id', 'alipay_key' => '安全检验码',"alipay_appid"=>"支付宝appid","alipay_rsaPrivateKey"=>"商户私钥(可填写路径)","alipay_alipayrsaPublicKey"=>"支付宝公钥(可填写路径)","icon" => "支付方式图标"];
    }
    ...
    public function getPayCode($order)
    {
        ...
        $parameter = array(
            ...
            "total_fee"			=> $order['order_money'],		//该笔订单的资金总额，单位为RMB-Yuan。取值范围为[0.01，100000000.00]，精确到小数点后两位。
