...
class Wxpay extends Pay implements Driver
{
    ...
    public function getDriverParam()
    {
        ...
        return ['appid' => 'appid 微信公众号唯一标识', 'appsecret' => 'appsecret', 'partnerid' => '受理商ID（商户号）', 'partnerkey' => '商户支付密钥Key',"icon" => "支付方式图标"];
    }
    ...
    public function driverInfo()
    {
        ...
        return ['driver_name' => '微信支付', 'driver_class' => 'Wxpay', 'driver_describe' => '微信支付', 'author' => 'Bigotry', 'version' => '1.0'];
    }
    ...
    public function getPayCode($order)
    {
        ...
        $unifiedOrder->setParameter("total_fee",$order['order_money']*100);	//总金额
