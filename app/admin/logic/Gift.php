...
class Gift extends AdminBase
{
     ...
     * 获取礼包列表
     */
    public function getGiftList($where = [], $field = 'gi.*,ga.game_name', $order = 'gi.create_time desc', $paginate = 0)
    {
        ...
        $list = $this->modelWgGift->getList($where, $field, $order, $paginate, $join);
